  ...
  return (
    <div className='p-5 lg:p-8 bg-primary-500 rounded-[2px] flex flex-col gap-4 w-[340px] sm:w-[440px]'>
      ...
      <div className='mt-5 text-center'>
        <p className='text-[15px] text-gray-200 text-center inline block'> Not a customer yet? </p>
        <Button as='link' href='/signup' className='  ml-1.5 hover:underline font-semibold text-[#5a99e8]'>
          Sign Up!
        </Button>
      </div>
    </div>
